...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x12(KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_DEL, MO(2), KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KC_BSPC, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LCTL, MO(6), KC_LGUI, KC_LALT, MO(3), KC_SPC, KC_SPC, MO(4), MO(5), KC_NO, KC_RCTL, KC_ENT),
  [1] = LAYOUT_ortho_4x12(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_DEL, MO(2), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_BSPC, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LCTL, MO(6), KC_LGUI, KC_LALT, MO(3), KC_SPC, KC_SPC, MO(4), MO(5), KC_NO, KC_RCTL, KC_ENT),
  [2] = LAYOUT_ortho_4x12(KC_NO, KC_ESC, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_DEL, KC_INS, KC_TRNS, LCTL(KC_A), KC_CAPS, KC_LSFT, KC_LCTL, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_BSPC, KC_NO, KC_NO, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LALT, KC_TRNS, KC_ENT, KC_ENT, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO),
  [3] = LAYOUT_ortho_4x12(KC_ESC, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_GRV, KC_NO, KC_NO, KC_LSFT, KC_LCTL, KC_NO, KC_QUOT, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DQUO, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_NO, KC_NO, KC_NO, KC_LALT, KC_NO, KC_ENT, KC_ENT, MO(7), KC_NO, KC_NO, KC_NO, KC_ENT),
